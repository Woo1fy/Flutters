...
class Spinner extends PositionComponent {
  Spinner(int intRank, int intSuit)
      : rank = Rank.fromInt(intRank),
        suit = Suit.fromInt(intSuit),
        _faceUp = false,
        super(size: SpinnersGame.cardSize);
  ...
  static final RRect cardRRect = RRect.fromRectAndRadius(
    SpinnersGame.cardSize.toRect(),
    const Radius.circular(SpinnersGame.cardRadius),
  );
  static final RRect backRRectInner = cardRRect.deflate(40);
  static late final Sprite flameSprite = spinnersSprite(1367, 6, 357, 501);
  ...
  static late final Sprite redJack = spinnersSprite(81, 565, 562, 488);
  static late final Sprite redQueen = spinnersSprite(717, 541, 486, 515);
  static late final Sprite redKing = spinnersSprite(1305, 532, 407, 549);
  static late final Sprite blackJack = spinnersSprite(81, 565, 562, 488)
    ..paint = blueFilter;
  static late final Sprite blackQueen = spinnersSprite(717, 541, 486, 515)
    ..paint = blueFilter;
  static late final Sprite blackKing = spinnersSprite(1305, 532, 407, 549)
    ..paint = blueFilter;
